...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "new", text: "Decides cómo te avisamos de cada cosa: para las convocatorias, las sesiones nuevas, los eventos o las fotos puedes elegir email, aviso en el móvil o nada" },
      { type: "new", text: "Puedes denunciar una foto, una opinión o un comentario que no debería estar ahí" },
      { type: "new", text: "Puedes bloquear a una persona y dejar de ver lo que publica" },
